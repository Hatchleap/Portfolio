...
const Footer = () => {
  ...
  if (!mounted) {
    return (
      <footer className="bg-purple-500 text-white px-6 md:px-12 lg:px-16 py-12" ref={footerRef}>
  ...
  return (
    <footer
      ref={footerRef}
      className="bg-purple-500 text-white px-6 md:px-12 lg:px-16 py-12"
    >
      <div className="flex flex-col md:flex-row justify-between gap-6 md:gap-8 lg:gap-12">
        {/* Left Section */}
        <div className="md:w-1/2 space-y-4">
          <h2 className={`text-4xl md:text-7xl font-bold ${base} ${revealed ? shown : hidden}`}>
            Let’s Talk
          </h2>
          ...
          <div className={`flex space-x-4 text-xl ${base} ${revealed ? `${shown} delay-200` : hidden}`}>
        ...
        <div className="md:w-1/4">
          <h3 className={`font-semibold text-lg mb-4 ${base} ${revealed ? `${shown} delay-100` : hidden}`}>
            Services
          </h3>
        ...
        {/* Right Section */}
        <div className="md:w-1/2 space-y-4">
          <h3 className={`font-semibold text-lg ${base} ${revealed ? `${shown} delay-100` : hidden}`}>
