  ...
  return (
    ...
    >
      <div className="max-w-screen-xl mx-auto flex items-center justify-between px-4 lg:px-6">
        ...
        {/* Mobile Menu Button */}
        <button
          className="lg:hidden p-2 text-black flex flex-col space-y-1 justify-center items-center w-8 h-8"
          onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
        >
          {mobileMenuOpen ? (
            // X icon
      ...
      >
        <div className="bg-black/90 backdrop-blur-md text-white px-4 py-3 space-y-2 rounded-b-2xl shadow-lg mx-3">
          <Link href="/" className="block py-2 hover:text-gray-300">
            HOME
          </Link>
          <Link href="/about" className="block py-2 hover:text-gray-300">
